    ...
    >
      ...
      >
        ...
        <div className="px-5 py-4 space-y-4">
          <div className="border-l-2 border-gray-300 bg-gray-50 px-4 py-3">
          ...
          <div>
            ...
            <input
              ...
              minLength={8}
              maxLength={63}
              className="w-full border border-gray-300 px-3 py-2 text-sm font-mono focus:outline-none focus:border-red-600 disabled:bg-gray-100"
            />
          </div>
          ...
          {error && (
            <div className="border-l-2 border-red-600 bg-gray-50 px-3 py-2 text-[12px] text-red-700">
              {error}
            </div>
          )}
        </div>
        ...
        <div className="border-t border-gray-200 px-5 py-3 flex gap-2 justify-end">
          <button
            ...
            onClick={onClose}
            disabled={busy}
            className="text-[11px] uppercase tracking-wider px-4 py-2 border border-gray-300 hover:bg-gray-50 text-gray-700 disabled:opacity-40"
          >
            Annulla
          </button>
          <button
            type="submit"
            disabled={busy}
            className="text-[11px] uppercase tracking-wider px-4 py-2 bg-red-600 hover:bg-red-700 text-white font-medium disabled:opacity-50"
          >
